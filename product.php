...
<div class="row b-black">
    ...
    <div class="col-md-6">
        <div class="product-wrap">
            <h3 class="c1 text-left family">&nbsp;&nbsp;IPHONE XS</h3>
            <img src="img/product1.PNG">
        </div>
    </div>
    <div class="col-md-6 no-p cus-wrap">
        <h4 class="black text-left family b-c2 discount-title">Avail 15% off exclusive on Iphone XS skins</h4>
            <div class="customize-wrap">
                    <h3 class="c1 text-left family">Lets Custmize</h3>
                    <br>
                    <h5 class="fff text-left">Select Device Color</h5>
                    <div class="col-md-12">
                        <button class="space-gray">Space Gray</button>
                        <button class="silver">Silver</button>
                    </div>
                    <h5 class="fff text-left">&nbsp;</h5>
                    <h5 class="fff text-left">Apple Cutout</h5>
                    <div class="col-md-12">
                        <button class="silver">with Cutout</button>
                        <button class="space-gray">without Cutout</button>
                        
                    </div>
                    <h5 class="fff text-left">&nbsp;</h5>
                    <h5 class="fff text-left">Texture</h5>
                    <div class="col-sm-4 texture">
                        <button class=""><img src="img/texture-dragon.PNG"></button>
                        <button class=""><img src="img/texture-dragon2.PNG"></button>
                        <p class="text-center">Metrix</p>
                    </div>
                    <div class="col-sm-4 texture">
                        <button class=""><img src="img/texture-dragon.PNG"></button>
                        <button class=""><img src="img/texture-dragon2.PNG"></button>
